...
export default async function SearchPage({ searchParams }: SearchPageProps) {
  ...
  if (q.trim()) {
    ...
    await (supabase.from("search_log") as any).insert({ term: q.trim() });
  }
  ...
  return (
    <section>
      ...
      <div className="mx-auto grid max-w-[1400px] grid-cols-[200px_1fr] gap-7 px-8 py-8 max-[860px]:grid-cols-1">
